# api/servidor_agente_floyd_warshall.py
...
from agentes_externos.floyd_warshall_externo import FloydWarshallExterno

# ==================================================
# CONFIGURACION DEL EQUIPO
# ==================================================

NOMBRE_GRUPO = "Grupo Floyd Warshall"
...
def movimiento():
    ...
    agente = FloydWarshallExterno(rol)
    ...
    direccion = agente.decidir_movimiento(estado)   # Calcular movimiento con Floyd-Warshall
